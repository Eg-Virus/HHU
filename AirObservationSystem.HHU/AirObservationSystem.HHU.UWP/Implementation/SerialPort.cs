...
{
    public class SerialPort : IMedia, INotifyPropertyChanged
    {
        ...
        public async Task<Result> InitializeMediaAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                Static.Log("InitializeMediaAsync", LogType.Error, $"Couldn't Initailize Serial Media: {ex.Message}");
        ...
        public async Task<Result> SendAsync(object obj)
        {
            ...
            {
                Static.Log("SendAsync", LogType.Error, $"Couldn't Send Through Serial Media: {ex.Message}");
        ...
        private async Task<Result> LoadDeviceInformation()
        {
            ...
            {
                Static.Log("LoadDeviceInformation", LogType.Error, ex.Message);
        ...
        private async void Listen()
        {
            ...
            {
                Static.Log("SendAsync", LogType.Error, ex.GetType().Name == "TaskCanceledException" ?
        ...
        private void CloseDevice()
        {
            ...
            {
                Static.Log("CloseDevice", LogType.Error, ex.Message);
